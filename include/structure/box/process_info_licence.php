...
$contenu_fichier_licence = '';
$chemin_fichier_licence = '../../../'.DIR_WS_TXT.'licence_'.LANGUAGE.'.txt'; // Chemin vers le fichier de présentation du service

// Vérifier si le fichier existe
if (file_exists($chemin_fichier_licence)) 
{
    // Lire le contenu du fichier
    $contenu_fichier_licence = file_get_contents($chemin_fichier_licence);
}

//Génération du code HTML
$html = '';

if(!empty($contenu_fichier_licence)) 
{	
	$html .= 
	"
