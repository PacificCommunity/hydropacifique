...
$sizeAugetFix = $dataInfo['sizeAugetFix'];
...
$sql_station_all = "SELECT DISTINCT s.id_station, s.nom_station, s.code_station, s.station_type, s.active_station,
                    s.id_region, s.id_regionhydro, s.id_riviere, s.id_commune
...
if($id_ra > 0) {
    $sql_RA = "SELECT DISTINCT ra.id_ra, from_nomad, new_nomad, hp_load,
                ...
                ra.num_cassette, ra.heure_init_cassette, ra.plu_heure_bascul1_cassette,
                ...
                ra.plu_ra_bouchage, ra.plu_ra_huile_tot, ra.ra_debroussaillage, ra.ra_eau_batterie, ra.ra_transfert_data, ra.ra_delete_memory,
    ...
    if (tep_db_num_rows($RA_query) > 0) {
        ...
        $plu_taille_auget = $RA_tab['plu_taille_auget'];
        ...
        $plu_heure_bascul1_cassette = $RA_tab['plu_heure_bascul1_cassette'];
        if($plu_heure_bascul1_cassette == '00:00:00') {$plu_heure_bascul1_cassette = '';}
        ...
        $plu_tot_type = $RA_tab['plu_tot_type'];
        $plu_tot_first = $RA_tab['plu_tot_first'];
        $plu_tot_last = $RA_tab['plu_tot_last'];
        $plu_tot_heure_basc = $RA_tab['plu_tot_heure_basc'];
        if($plu_tot_heure_basc == '00:00:00') {$plu_tot_heure_basc = '';}

        $plu_cumul_tot = $RA_tab['plu_cumul_tot'];
        $plu_cumul_plu = $RA_tab['plu_cumul_plu'];

        $plu_diff_tot_plu = $RA_tab['plu_diff_tot_plu'];

        $plu_recalage_heure_plu = $RA_tab['plu_recalage_heure_plu'];
        if($plu_recalage_heure_plu == '00:00:00') {$plu_recalage_heure_plu = '';}

        $plu_test_auget = $RA_tab['plu_test_auget'];
        $plu_nb_basculement = $RA_tab['plu_nb_basculement'];

        $check_bouchage = $RA_tab['plu_ra_bouchage'];
        $check_huile = $RA_tab['plu_ra_huile_tot'];
        ...
        if(isset($station_all_array) && sizeof($station_all_array) > 0) 
        {
            if($ra_exist) {
                ...
                $tab_html .= "<table id='tab_titre_popup' cellspacing='0'>";
                    $tab_html .= "<tr>";
                        $tab_html .= "<td class='titre'>";
                            ...
                            // ---- Modify checkbox ----
                            $tab_html .= "<div style='float:left;width:30px;height:30px;margin-top:0px;margin-right:50px;'>";
                            ...
                            $tab_html .= "<div style='float:left;width:600px;margin-top:10px;'>";
                                $tab_html .= "<select name='select_station_ra' id='select_station_ra' class='titre_ra'
                                              style='width:100%;'
                                              onChange='lists_reload();lastRa_Plu();'>";
                                    ...
                                    if(isset($station_all_array)) {
                                        foreach($station_all_array as $key => $value) {
                                            ...
                                            $tab_html .= "<option value='".$key."' ".$selected." style='font-weight:normal;'>".$value['code_station']." - ".$value['nom_station']."</option>";
                                        }
                                    }
                                $tab_html .= "</select>";
                            $tab_html .= "</div>";
                ...
                $tab_html .= "<div id='boxContent-RA' style='margin-right:5px;'>";
                    ...
                    $tab_html .= "<div id='boxContent-RA-small'>";
                        ...
                        $tab_html .= "<input style='width:80px;' id='date_releve' name='date_releve'
                                    ...
                                    onChange='lastRa_Plu()' type='text' placeholder='dd-mm-yyyy'>";
                    $tab_html .= "</div>";
                    ...
                    $tab_html .= "<div id='boxContent-RA-small'>";
                        ...
                        $tab_html .= "<input name='heure_releve' id='heure_releve'
                                      value='".$heure_ra."' onChange='lastRa_Plu()' onfocus='setHeureNow(this)'
                ...
                $tab_html .= "<div id='boxContent-RA'>";
                    ...
                    // Number of tippings
                    $tab_html .= "<div id='boxContent-RA-small'>";
                        $tab_html .= "<p>".TEXT_NB_TIPPINGS."</p>";
                        $tab_html .= "<input name='plu_nb_basculement' id='plu_nb_basculement'
                                      value='".$plu_nb_basculement."'
                                      onChange='raPlu_calculPlaceholder(".$sizeAugetFix.");'
                    ...
                    $tab_html .= "<div id='boxContent-RA-small'>";
                        ...
                        $tab_html .= "<input name='nb_octet' id='nb_octet' value='".$nb_octet."' style='width:40px;' type='text'>";
                    $tab_html .= "</div>";
                    ...
                    if(INIT_T == 'NC') 
                    {
                        $tab_html .= "<div id='boxContent-RA-small'>";
                            ...
                            $tab_html .= "<input name='num_batterie' id='num_batterie' value='".$num_batterie."' style='width:70px;' type='text'>";
                        $tab_html .= "</div>";
                    }
                    ...
                    $tab_html .= "<div id='boxContent-RA-small' style='margin-right:5px;'>";
                        ...
                        $tab_html .= "<input name='tension_batterie' id='tension_batterie' value='".$tension_batterie."' style='width:40px;' type='text'>";
                    $tab_html .= "</div>";
                ...
                // ====================================================================
                // LINE 2 : Previous reading + Totalizer + Control
                // ====================================================================

                if(INIT_T == 'NC' || INIT_T == 'PF') 
                {
                    // ---- Box: Previous reading ----
                    $tab_html .= "<div id='boxContent-RA' style='margin-right:5px;'>";

                        $tab_html .= "<div id='boxContent-RA-title'>";
                            $tab_html .= "<p>".TEXT_PREVIOUS."</p>";
                        $tab_html .= "</div>";

                        $tab_html .= "<div id='info_last_ra' style='padding:0 5px;font-size:13px;'></div>";

                    $tab_html .= "</div>"; // end Box: Previous
                    ...
                    $tab_html .= "<div id='boxContent-RA' style='margin-right:5px;'>";
                        ...
                        $tab_html .= "<div id='boxContent-RA-title'>";
                            $tab_html .= "<p>".TEXT_TOTALIZER."</p>";
                        $tab_html .= "</div>";

                        $tab_html .= "<div id='boxContent-RA-small'>";
                            $tab_html .= "<p>".TEXT_TOTAL_TYPE."</p>";
                            $tab_html .= "<input name='plu_tot_type' id='plu_tot_type' value='".$plu_tot_type."' style='width:50px;' type='text'>";
                        $tab_html .= "</div>";

                        $tab_html .= "<div id='boxContent-RA-small'>";
                            $tab_html .= "<p>".TEXT_CUMUL_ARRIVAL."</p>";
                            $tab_html .= "<input name='plu_tot_first' id='plu_tot_first' value='".$plu_tot_first."'
                                        onChange='raPlu_calculPlaceholder(".$sizeAugetFix.");'
                                        style='width:40px;' type='text'>";
                        ...
                        $tab_html .= "<div id='boxContent-RA-small'>";
                            $tab_html .= "<p>".TEXT_CUMUL_DEPARTURE."</p>";
                            $tab_html .= "<input name='plu_tot_last' id='plu_tot_last' value='".$plu_tot_last."' style='width:40px;' type='text'>";
                            $tab_html .= "<span style='margin-left:5px;font-size:14px;'>".$unite_ra."</span>";
                        $tab_html .= "</div>";
                        ...
                        {
                            $tab_html .= "<div id='boxContent-RA-small' style='margin-right:5px;'>";
                                $tab_html .= "<p>".TEXT_TIPPING_TIME."</p>";
                                $tab_html .= "<input name='plu_tot_heure_basc' id='plu_tot_heure_basc'
                                            placeholder='hh:mm:ss' value='".$plu_tot_heure_basc."'
                                            style='width:55px;' type='text'>";
                            $tab_html .= "</div>";
                        }

                    $tab_html .= "</div>"; // end Box: Totalizer
                    ...
                    $tab_html .= "<div id='boxContent-RA'>";
                        ...
                        $tab_html .= "<div id='boxContent-RA-title'>";
                            $tab_html .= "<p>".TEXT_CONTROL."</p>";
                        $tab_html .= "</div>";

                        $tab_html .= "<div id='boxContent-RA-small'>";
                            $tab_html .= "<p>".TEXT_CUMUL_TOTAL."</p>";
                            $tab_html .= "<input name='plu_cumul_tot' id='plu_cumul_tot' class='input-calc'
                                        value='".$plu_cumul_tot."' 
                                        onChange='raPlu_calculPlaceholder(".$sizeAugetFix.");'
                                        style='width:40px;' type='text'>";
                            $tab_html .= "<span style='margin-left:5px;font-size:14px;'>".$unite_ra."</span>";
                        ...
                        $tab_html .= "<div id='boxContent-RA-small'>";
                            $tab_html .= "<p>".TEXT_CUMUL_RAIN."</p>";
                            $tab_html .= "<input name='plu_cumul_plu' id='plu_cumul_plu' class='input-calc'
                                        value='".$plu_cumul_plu."' 
                                        onChange='raPlu_calculPlaceholder(".$sizeAugetFix.");'
                                        style='width:40px;' type='text'>";
                            $tab_html .= "<span style='margin-left:5px;font-size:14px;'>".$unite_ra."</span>";
                        ...
                        $tab_html .= "<div id='boxContent-RA-small'>";
                            $tab_html .= "<p>".TEXT_TOTAL_RAIN."</p>";
                            $tab_html .= "<input name='plu_diff_tot_plu' id='plu_diff_tot_plu' class='input-calc'
                                        value='".$plu_diff_tot_plu."' style='width:40px;' type='text'>";
                            $tab_html .= "<span style='margin-left:5px;font-size:14px;'>".$unite_ra."</span>";
                        $tab_html .= "</div>";

                        $tab_html .= "<div id='boxContent-RA-small'>";
                            $tab_html .= "<p>".TEXT_TIME_ADJUSTMENT."</p>";
                            $tab_html .= "<input name='plu_recalage_heure_plu' id='plu_recalage_heure_plu'
                                        value='".$plu_recalage_heure_plu."' placeholder='hh:mm'
                                        style='width:50px;' type='text'>";
                        $tab_html .= "</div>";

                        $tab_html .= "<div id='boxContent-RA-small' style='margin-right:5px;'>";
                            $tab_html .= "<p>".TEXT_AUGET_TEST."</p>";
                            $tab_html .= "<input name='plu_test_auget' id='plu_test_auget'
                                        value='".$plu_test_auget."' style='width:40px;' type='text'>";
                        $tab_html .= "</div>";

                    $tab_html .= "</div>"; // end Box: Control
                    ...
                    $tab_html .= "<div id='displayFieldRa' style='display:none;'>";
                        ...
                        $tab_html .= "<div id='boxContent-RA'>";
                            ...
                            $tab_html .= "<div id='boxContent-RA-small'>";
                                ...
                                $tab_html .= "<input name='num_cassette' id='num_cassette' value='".$num_cassette."' style='width:70px;' type='text'>";
                            $tab_html .= "</div>";

                            $tab_html .= "<div id='boxContent-RA-small'>";
                                $tab_html .= "<p>".TEXT_INIT_TIME."</p>";
                                $tab_html .= "<input name='heure_init_cassette' id='heure_init_cassette'
                                            value='".$heure_init_cassette."' placeholder='hh:mm:ss'
                                            style='width:55px;' type='text'>";
                            $tab_html .= "</div>";

                            $tab_html .= "<div id='boxContent-RA-small' style='margin-right:5px;'>";
                                $tab_html .= "<p>".TEXT_FIRST_TIPPING_TIME."</p>";
                                $tab_html .= "<input name='plu_heure_bascul1_cassette' id='plu_heure_bascul1_cassette'
                                            value='".$plu_heure_bascul1_cassette."' placeholder='hh:mm:ss'
                                            style='width:55px;' type='text'>";
                            $tab_html .= "</div>";
                ...
                $tab_html .= "<div id='boxContent-RA' style='margin-right:5px;'>";
                    ...
                    $tab_html .= "<div id='boxContent-RA-small' style='margin:0;'>";
                        ...
                        $checked = '';
                        if($check_bouchage>0) {$checked = 'checked';}
                        $tab_html .= "<div>";
                            $tab_html .= "<input class='input_texte' style='width:25px;' name='check_bouchage' id='check_bouchage' type='checkbox' ".$checked.">";
                            $tab_html .= "<span style='float:left;margin-top:2px;width:110px;font-size:13px;'>".TEXT_CLOGGING."</span>";
                            $tab_html .= "<hr>";
                        $tab_html .= "</div>";
                        ...
                        {
                            $checked = '';
                            if($check_huile>0) {$checked = 'checked';}
                            $tab_html .= "<div>";
                                $tab_html .= "<input class='input_texte' style='width:25px;' name='check_huile' id='check_huile' type='checkbox' ".$checked.">";
                                $tab_html .= "<span style='float:left;margin-top:2px;width:110px;font-size:13px;'>".TEXT_TOTAL_OIL."</span>";
                                $tab_html .= "<hr>";
                            $tab_html .= "</div>";
                        }
                        ...
                        if(isset($agent_array)) {
                            foreach($agent_array as $key => $value) {
                                ...
                                $tab_html .= "<div style='float:left;'>";
                                    $tab_html .= "<input class='input_texte' style='width:15px;height:20px;padding:0;' name='check_agent_".$key."' id='check_agent_".$key."' type='checkbox' data-value='".$value."' onchange='updateSelectedAgents();' ".$checked.">";
