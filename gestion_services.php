    ...
    echo "<div id='contour_general'>";
        echo "<div id='contenu_centre'>";
            echo "<div id='contenu_box2'>";
                ...
                echo "<form name='formService' id='formService'>";
                    ...
                    echo "<h1>";
                        ...
                        echo "<p style='float:left;margin-right:25px;'>";
                            echo "<span>" . TEXT_SV_PAGE_TITLE . "</span>";
                        echo "</p>";
                    ...
                    echo "<div id='onglet'>";
                        echo "<ul id='menu_onglet'>";
                            echo "<li id='onglet-0' class='actif'>" . TEXT_SV_TAB_LABEL . "</li>\n";
                        echo "</ul>";

                        echo "<div id='contenu-0' class='contenu'>";
                            require(DIR_WS_ADMIN . 'form_service_1.php');
                        echo "</div>";
                    echo "</div>";
...
<script>
    ...
    function saveService(event)
    {
        ...
        var formService = new FormData(document.getElementById('formService'));

        var xhr = new XMLHttpRequest();
        xhr.open("POST", "include/structure/admin/process_service_save.php", true);
    ...
    document.getElementById('formService').addEventListener('submit', saveService);
